                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a id="" href="./edit-user-role.php?id=<?php echo $user['userId']?>" type="button"
                                        class="btn btn-outline-success  ">Edit</a></td>
                                <td><a id="" href="../profile-details.php?id=<?php echo $user['userId']?>" type="button"
                                        class="btn btn-outline-primary">Show</a></td>
                                <td><a id=""
                                        href="../../Controller/user-action/delete-user.php?id=<?php echo $user['userId']?>"
